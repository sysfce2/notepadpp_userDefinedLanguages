...
| [ASM for Intel 8051](./UDLs/AsmForIntel8051_byJackMaynard.xml) | [Jack Maynard](mailto:jackamaynard@yahoo.com) | ASM for Intel 8051 |
...
| [Markdown-plus-plus](https://raw.githubusercontent.com/Edditoria/markdown-plus-plus/refs/heads/master/udl/markdown.default.udl.xml) | [Edditoria](https://github.com/Edditoria/markdown-plus-plus) |  <details> <summary> Markdown syntax highlighting. In dev stage of supporting GitHub Flavored Markdown (GFM). More </summary>  themes to download in the repository. </details> |
...
| [PowerBuilder DarkMode](./UDLs/PowerBuilder_DM_byFa0lin.xml) | [Fa0lin](https://github.com/Fa0lin/powerbuilder-darkmode-udl-notepadplusplus) | PowerBuilder syntax highlighting for dark mode |
...
| [Wiki VKontakte](./UDLs/WikiVKontakte_by-ordorub.xml) | [Иван Бойко](mailto:ordorub@ya.ru) | Wiki VKontakte |
...
| [OptiStruct](./autoCompletion/OptiStruct.xml) | generate_ac.py | Siemens OptiStruct FEM solver |
...
| [Sage X3 4GL Dark](./autoCompletion/Sage%20X3%204GL%28Darkmode%29.xml) | generate_ac.py | 4GL for Sage X3 |
| [Sap ABAP](./autoCompletion/Abap.xml) | generate_ac.py | Sap ABAP |
| [SAP NetWeaver IdM language](./autoCompletion/SAP%20IdM.xml) | generate_ac.py | SAP NetWeaver IdM language |
| [SAP Web Intelligence Formula Editor](./autoCompletion/WebI%20script.xml) | generate_ac.py | SAP Web Intelligence Formula Editor |
| [SAS](./autoCompletion/SAS.xml) | generate_ac.py | SAS |
| [SAS (dark style) v1](./autoCompletion/SAS%20MBStyle%20Dark%20v1.1.xml) | generate_ac.py | SAS for dark NPP styles |
| [SAS (light style) v1](./autoCompletion/SAS%20MBStyle%20v1.1.xml) | generate_ac.py | SAS for light NPP styles |
| [SAS with pseudocode](./autoCompletion/SAS_UDL2.xml) | generate_ac.py | SAS with pseudocode |
| [Scala](./autoCompletion/Scala.xml) | generate_ac.py | Scala  |
| [Schlumberger Eclipse](./autoCompletion/Eclipse.xml) | generate_ac.py | Schlumberger Eclipse |
...
| [Smali](./autoCompletion/Smali.xml) | generate_ac.py | Smali |
| [Smartsheet](./autoCompletion/Smartsheet.xml) | [Kevin Dickinson](mailto:ktdickinson@gmail.com) | Smartsheet |
| [Smarty](./autoCompletion/Smarty.xml) | generate_ac.py | Smarty |
| [Snort](./autoCompletion/Snort.xml) | generate_ac.py | Snort |
| [Snowflake SQL (Default Theme)](./autoCompletion/Snowflake%20SQL%20%28Default%20Theme%29.xml) | generate_ac.py | SQL for Snowflake dialect based on SQL default theme |
...
| [STL 3dObject](./autoCompletion/STL%203dObject.xml) | generate_ac.py | 3d Stereolithography ASCII file (STL) |
| [STOL](./autoCompletion/STOL.xml) | generate_ac.py | STOL |
| [Structured text for PLC programming (B&amp;R controllers)](./autoCompletion/Structured%20Text.xml) | generate_ac.py | Structured text for PLC programming (B&amp;R controllers) |
...
| [TACL](./autoCompletion/TACL.xml) | generate_ac.py | TACL |
| [Template Toolkit](./autoCompletion/TemplateToolkit.xml) | generate_ac.py | Template Toolkit |
| [Teradata Macro Language (Term)](./autoCompletion/Teradata.xml) | generate_ac.py | Teradata Macro Language (Term) |
...
| [TOML](./autoCompletion/TOML.xml) | generate_ac.py | Tom's Obvious, Minimal Language |
| [TradeStation Easy Language](./autoCompletion/EasyLanguage.xml) | generate_ac.py | TradeStation Easy Language |
| [TSL](./autoCompletion/TSL.xml) | generate_ac.py | TSL |
| [TTL](./autoCompletion/TTL.xml) | generate_ac.py | TeraTermLanguage support with highlighting of all cmds of V4 |
| [Turtle RDF syntax](./autoCompletion/Turtle.xml) | generate_ac.py | Turtle RDF syntax |
| [Twig](./autoCompletion/Twig.xml) | generate_ac.py | Twig |
| [twinBASIC](./autoCompletion/twinBASIC.xml) | generate_ac.py | twinBASIC syntax highlighting |
| [twinBASIC_dark](./autoCompletion/twinBASIC_dark.xml) | generate_ac.py | twinBASIC syntax highlighting (dark version) |
| [TypeScript](./autoCompletion/TypeScript.xml) | generate_ac.py | TypeScript |
| [UniBASIC](./autoCompletion/UniBASIC.xml) | generate_ac.py | UniBASIC |
| [VectorScript](./autoCompletion/VectorScript.xml) | generate_ac.py | VectorScript |
| [VENOM](./autoCompletion/VENOM.xml) | generate_ac.py | VENOM |
...
| [Vim script (Obsidian)](./autoCompletion/Vim%20script%20%28Obsidian%29.xml) | [Robert Di Pardo](https://gist.github.com/rdipardo/b8d586e156f543afc84690ac9ddf8e91) | User Defined Language for Vim script (based on the Obsidian theme) |
| [vislcg3](./autoCompletion/vislcg3.xml) | generate_ac.py | vislcg3 |
| [Visual DataFlex](./autoCompletion/Visual%20DataFlex.xml) | generate_ac.py | Visual DataFlex |
| [Visual FoxPro](./autoCompletion/Visual%20FoxPro.xml) | generate_ac.py | Visual FoxPro |
| [VRML (defs and API)](./autoCompletion/VRML.xml) | generate_ac.py | VRML (defs and API) |
| [Wavefront OBJ](./autoCompletion/Wavefront%20OBJ.xml) | generate_ac.py | Wavefront OBJ |
| [WebFOCUS](./autoCompletion/WebFOCUS.xml) | generate_ac.py | WebFOCUS |
| [Wiki VKontakte](./autoCompletion/Wiki%20VKontakte.xml) | generate_ac.py | Wiki VKontakte |
| [WinBatch](./autoCompletion/WinBatch.xml) | generate_ac.py | WinBatch |
| [WinDev WLanguage](./autoCompletion/Wlangage.xml) | generate_ac.py | WinDev WLanguage |
| [WSH Panel Mod](./autoCompletion/JScript-WSHPM.xml) | generate_ac.py | WSH Panel Mod |
| [X3D](./autoCompletion/X3DV.xml) | generate_ac.py | X3D |
| [XC=BASIC 3](./autoCompletion/xcbasic3.xml) | generate_ac.py | XC=BASIC 3 syntax highlighting |
| [XMOS xCORE XC Programming Language](./autoCompletion/XC.xml) | generate_ac.py | XMOS xCORE XC Programming Language |
| [YARA](./autoCompletion/YARA.xml) | generate_ac.py | YARA syntax highlighting for Notepad++. |
| [Zig](./autoCompletion/Zig.xml) | generate_ac.py | Zig |
